...
public class CreateCategoryBatchUseCase implements UseCase<ProductCategoryDto> {

    private final String token;
    private final ProductCategoryDto[] categoryList;

    public CreateCategoryBatchUseCase(String token, ProductCategoryDto[] categoryList) {
        this.token = token;
    ...
    public String getUri() {
        return PRODUCT_CATEGORY_URI + "/batch";
    }
