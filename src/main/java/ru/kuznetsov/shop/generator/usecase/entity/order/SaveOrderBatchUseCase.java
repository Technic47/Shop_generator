...
public class SaveOrderBatchUseCase implements UseCase<OrderDto> {

    private final String token;
    private final OrderDto[] orderList;

    public SaveOrderBatchUseCase(String token, OrderDto[] orderList) {
        this.token = token;
