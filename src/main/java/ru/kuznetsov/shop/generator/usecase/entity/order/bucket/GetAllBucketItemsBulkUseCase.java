...
public class GetAllBucketItemsBulkUseCase implements UseCase<BucketItemDto> {

    private final String token;

    public GetAllBucketItemsBulkUseCase(String token) {
        this.token = token;
    }

    @Override
    public String getUri() {
        return ORDER_BUCKET_URI + "/bulk";
    }
