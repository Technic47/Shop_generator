...
public class GetAllOrderStatusBulkUseCase implements UseCase<OrderStatusDto> {

    private final String token;

    public GetAllOrderStatusBulkUseCase(String token) {
        this.token = token;
    }

    @Override
    public String getUri() {
        return ORDER_STATUS_URI + "/bulk";
    }
