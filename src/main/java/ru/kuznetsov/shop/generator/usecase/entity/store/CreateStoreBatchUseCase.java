...
public class CreateStoreBatchUseCase implements UseCase<StoreDto> {

    private final String token;
    private final StoreDto[] storeList;

    public CreateStoreBatchUseCase(String token, StoreDto[] storeList) {
        this.token = token;
