...
public class GetProductCardsUseCase implements UseCase<ProductCardDto> {

    private final String token;
    private final UUID ownerId;
    private final Long categoryId;

    public GetProductCardsUseCase(String token, UUID ownerId, Long categoryId) {
        this.token = token;
