...
public class GetAllCategoriesBulkUseCase implements UseCase<ProductCategoryDto> {

    private final String token;

    public GetAllCategoriesBulkUseCase(String token) {
        this.token = token;
    }

    @Override
    public String getUri() {
        return PRODUCT_CATEGORY_URI + "/bulk";
    }
