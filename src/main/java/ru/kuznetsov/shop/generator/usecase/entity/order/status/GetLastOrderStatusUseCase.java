...
public class GetLastOrderStatusUseCase implements UseCase<OrderStatusDto> {

    private final String token;
    private final Long orderId;

    public GetLastOrderStatusUseCase(String token, Long orderId) {
        this.token = token;
