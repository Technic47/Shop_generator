...
public class GetCategoryByIdUseCase implements UseCase<ProductCategoryDto> {

    private final String token;
    private final Long id;

    public GetCategoryByIdUseCase(String token, Long id) {
        this.token = token;
        this.id = id;
    }
    ...
    public String getUri() {
        return PRODUCT_CATEGORY_URI + "/" + id;
    }
