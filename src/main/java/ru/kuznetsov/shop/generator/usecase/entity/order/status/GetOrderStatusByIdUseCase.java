...
public class GetOrderStatusByIdUseCase implements UseCase<OrderStatusDto> {

    private final String token;
    private final Long id;

    public GetOrderStatusByIdUseCase(String token, Long id) {
        this.token = token;
        this.id = id;
    }
