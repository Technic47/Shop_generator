...
public interface ConstValues {
    ...
    String STORE_AMOUNT_PARAMETER = "STORE_AMOUNT";
    String CATEGORY_AMOUNT_PARAMETER = "CATEGORY_AMOUNT";
    String PRODUCT_AMOUNT_PARAMETER = "PRODUCT_AMOUNT";
    String STORE_MAX_AMOUNT_PARAMETER = "STORE_MAX_AMOUNT";
}
